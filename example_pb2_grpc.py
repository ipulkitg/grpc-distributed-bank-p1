...
class BranchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MsgDelivery = channel.unary_unary(
                '/Branch/MsgDelivery',
                request_serializer=example__pb2.MsgRequest.SerializeToString,
                response_deserializer=example__pb2.MsgResponse.FromString,
                )
...
def add_BranchServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MsgDelivery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=example__pb2.MsgRequest.FromString,
                    response_serializer=example__pb2.MsgResponse.SerializeToString,
            ),
...
class Branch(object):
    ...
    def MsgDelivery(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Branch/MsgDelivery',
            example__pb2.MsgRequest.SerializeToString,
            example__pb2.MsgResponse.FromString,
